...
class Minigames(commands.Cog):
    ...
    async def show_recipes(self, ctx):
        ...
        recipes = [
            ("Sweet Veg. Cake", "50 Cementing Paste"), ("Kibble", "1 Fiber"), ("Colors", "1 Thatch"), 
            ("Shadow Steak", "1 Raw Meat"), ("Mindwipe Tonic", "200 Mejoberries"), ("Medical Brew", "1 Tintoberry"),
            ("Battle Tartare", "10 Crystal"), ("Beer Jar", "5 Thatch"), ("Cactus Broth", "50 Stone"),
            ("Mushroom Brew", "5 Aquatic Mushroom"), ("Focal Chili", "100 Raw Metal"), ("Bug Repellent", "1 Chitin/Keratin")
        ]
